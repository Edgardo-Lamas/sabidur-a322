...
const chapters = [
    ...
    },
    {
        ...
        subtitle: 'La Quinta Perfección de Dios',
        description: 'El Juez de toda la tierra siempre hará lo recto. La justicia como rectitud eterna, su revelación en la Escritura, su expresión perfecta en la cruz y su poder para transformar al creyente justificado.',
        slug: 'capitulo-5',
        disponible: true,
    },
